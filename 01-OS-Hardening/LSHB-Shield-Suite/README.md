# 🛡️ LSHB Shield Suite v3.0
**Desarrollado por: Jhonnf Arias - Ingeniero de Sistemas & Cybersecurity Expert**

Esta suite es una herramienta profesional diseñada para el **Hardening (Fortificación)**, **Auditoría** y **Generación de Reportes** automatizados en servidores Linux, optimizada específicamente para arquitecturas modernas como **Ubuntu 24.04**.

## 🚀 Características Principales
- **Blindaje SSH:** Cambio de puerto automático (2244), desactivación de acceso Root y fuerza bruta.
- **Auto-Remediación:** Escanea vulnerabilidades y ofrece repararlas en caliente con un solo clic.
